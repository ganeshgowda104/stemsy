...
import HomeoneColumnrunstreak from "./HomeoneColumnrunstreak";
import HomeoneRowwaytogo from "./HomeoneRowwaytogo";
...
export default function HomeOnePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Shravan&#39;s Application</title>
        <meta
          name="description"
            ...
            <div className="relative mr-5 h-[226px] md:mr-0">
              <div className="absolute left-0 right-0 top-1.5 m-auto h-[180px] flex-1 content-center rounded-[10px] bg-amber-300_01 lg:h-auto md:h-auto">
                ...
                <Img
                  ...
                  alt="Image"
                  className="absolute bottom-0 left-0 right- top-0 m-auto h-[180px] flex-1 rounded-[10px] object-cover"
                />
              </div>
              <Img
                src="images/img_development_of_preschool.png"
                alt="Developmentof"
                className="absolute bottom- right-[5%] top-0 my-auto h-[226px] w-[226px] object-cover"
              />
            </div>
              ...
              <div className="flex flex-col gap-[18px]">
                ...
                <div className="flex items-start justify-center md:flex-col">
                  <div className="flex w-[96%] items-center justify-center gap-6 self-center overflow-auto overflow-x-scroll md:w-full md:flex-col">
                    <div className="mx-auto mb-5 flex w-[2000px] gap-6 md:mx-> md:flex-col">
                      <Slider
                        autoplay
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="mt-6 flex items-start self-stretch md:flex-col">
                  <div className="flex w-[96%] items-center gap-6 self-center overflow-auto overflow-x-scroll md:w-full md:flex-col">
                    <div className="mx-auto mb-5 flex w-[2016px] gap-6 md:mx-> md:flex-col">
                      <Slider
                        autoplay
                        autoPlayInterval={2000}
                        responsive={{
            ...
            <div className="relative h-[832px] content-center lg:h-auto md:h-auto">
              <div className="mx-auto flex flex-1 flex-col gap-[26px] rounded-[10px] border border-solid border-blue_gray-100_02 bg-blue-50">
                ...
                <div className="flex flex-col gap-6 rounded-[10px] bg-gray-50 py-3">
                  <HomeoneColumnrunstreak />
                  <div className="mx-3 md:mx-0">
                    <div className="rounded-[10px] bg-blue-800">
                      <div className="flex flex-col items-center rounded-[10px]">
                        <Heading
                          size="headingxl"
                          as="h5"
                          className="mt-[54px] tracking-[-0.69px] !text-white-a700 md:text-[24px] sm:text-[22px]"
                        >
                          Daily Fun
                        </Heading>
                        <Heading
                        ...
                        <div className="ml-10 mr-[34px] mt-[34px] flex flex-col gap-2.5 self-stretch md:mx-0">
                          ...
                          <div className="mx-10 flex flex-wrap md:mx-10">
                            <Text
                              size="text6xl"
                              as="p"
                              className="flex h-[28px] w-[28px] items-center justify-center rounded-[3px] bg-white-a700 text-center text-[24.62px] tracking-[-0.57px] !text-black-900"
