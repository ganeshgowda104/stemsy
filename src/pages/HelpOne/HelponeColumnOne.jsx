...
const accordionData = [
  {
    processtoget3: "Process to get started in the website?",
  },
  {
    processtoget3: "Process to get started in the website?",
  },
...
const accordionData1 = [
  {
    processtoget2: "Process to get started in the website?",
  },
  {
    howtousethe1: "How to use the whiteboard?",
  },
  {
    processtoget2: "How to get the notifications?",
  },
  {
    processtoget2: "How to navigate the settings?",
  },
];

export default function HelponeColumnOne() {
  return (
                            ...
                            <div className="mt-1 flex items-center justify-between gap-5">
                              <div className="flex flex-1 items-center gap-5">
                                {props?.expanded ? (
                                  ...
                                  <Img
                                    src="images/img_ellipse_526_12x12.svg"
                                    alt="Image"
